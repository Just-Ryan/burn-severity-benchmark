...
\ShortHeadings{Five protocol audits of a burn severity benchmark}{Altayeb, Alraddadi and Alrehaili}
...
% The present title claims only what the paper demonstrates: that a second,
% independent look changed the answer five times.
\title{What a second look changed: five protocol audits of a deep learning
benchmark for burn severity assessment}
